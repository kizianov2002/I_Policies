...
#include "ui_print_notice_pol_wnd.h"

print_notice_pol_wnd::print_notice_pol_wnd(QSqlDatabase &db, s_data_app &data_app, s_data_pers &data_pers, s_data_vizit &data_vizit, s_data_polis &data_polis, QSettings &settings, QWidget *parent)
 : db(db), data_app(data_app), data_pers(data_pers), data_vizit(data_vizit), data_polis(data_polis), QDialog(parent), settings(settings), ui(new Ui::print_notice_pol_wnd)
{
    ui->setupUi(this);
...
print_notice_pol_wnd::~print_notice_pol_wnd() {
    delete ui;
}

void print_notice_pol_wnd::on_bn_close_clicked() {
    reject();
}

QString print_notice_pol_wnd::date_to_str(QDate date) {
...
void print_notice_pol_wnd::on_bn_print_clicked() {
    ...
    QString rep_template = rep_folder + "pol_notice.odt";
    ...
    // архивация шаблона
    // ===========================
    QString fname_res = data_app.path_out + "_POL_NOTICES_/pol_notice - " + data_pers.fam + " " + data_pers.im + " " + data_pers.ot + " - " + date_to_str(data_pers.date_birth) + "odt";
...
void print_notice_pol_wnd::on_bn_edit_clicked(bool checked) {
    if (checked) {
...
void print_notice_pol_wnd::on_bn_edit_clicked()
{
