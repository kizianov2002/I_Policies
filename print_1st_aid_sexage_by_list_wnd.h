#ifndef print_1st_aid_sexage_by_list_wnd_H
#define print_1st_aid_sexage_by_list_wnd_H
...
namespace Ui {
class print_1st_aid_sexage_by_list_wnd;
}

class print_1st_aid_sexage_by_list_wnd : public QDialog
{
    Q_OBJECT
...
public:
    explicit print_1st_aid_sexage_by_list_wnd(QSqlDatabase &db, s_data_app &data_app, QSettings &settings, QWidget *parent = 0);
    ~print_1st_aid_sexage_by_list_wnd();
...
private:
    Ui::print_1st_aid_sexage_by_list_wnd *ui;
};

#endif // print_1st_aid_sexage_by_list_wnd_H
