#ifndef ACT_vs2point_WND_H
#define ACT_vs2point_WND_H
...
// параметры акта передачи ВС на ПВП
typedef struct {
    int     id;         // ID акта
...
namespace Ui {
class act_vs2point_wnd;
}

class act_vs2point_wnd : public QDialog
{
    Q_OBJECT
...
public:
    explicit act_vs2point_wnd(QSqlDatabase &db, s_data_app &data_app, s_data_act_vs2point &data_act, QSettings &settings, QWidget *parent = 0);
    ~act_vs2point_wnd();
...
private:
    Ui::act_vs2point_wnd *ui;
};

#endif // ACT_vs2point_WND_H
