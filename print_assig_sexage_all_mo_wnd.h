#ifndef print_assig_sexage_all_mo_wnd_H
#define print_assig_sexage_all_mo_wnd_H
...
namespace Ui {
class print_assig_sexage_all_mo_wnd;
}

class print_assig_sexage_all_mo_wnd : public QDialog
{
    Q_OBJECT
...
public:
    explicit print_assig_sexage_all_mo_wnd(QSqlDatabase &db, s_data_app &data_app, QSettings &settings, QWidget *parent = 0);
    ~print_assig_sexage_all_mo_wnd();
...
private:
    Ui::print_assig_sexage_all_mo_wnd *ui;
};

#endif // print_assig_sexage_all_mo_wnd_H
