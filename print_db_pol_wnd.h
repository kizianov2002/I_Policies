#ifndef PRINT_DB_POL_WND_H
#define PRINT_DB_POL_WND_H
...
namespace Ui {
class print_db_pol_wnd;
}

class print_db_pol_wnd : public QDialog
{
    Q_OBJECT
...
public:
    explicit print_db_pol_wnd(QSqlDatabase &db, s_data_app &data_app, s_data_pers &data_pers, s_data_vizit &data_vizit, s_data_polis &data_polis, QSettings &settings, QWidget *parent = 0);
    ~print_db_pol_wnd();
...
private:
    Ui::print_db_pol_wnd *ui;
};

#endif // PRINT_DB_POL_WND_H
